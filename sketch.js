...
function draw() {
  ...
  if (gameState===PLAY){
    ...
    //touches-array, stores the x, y position of the point you touch
    // if there is anything inside the touches then make trex jump
...
function spawnClouds() {
  ...
  if (frameCount % 60 === 0) {
    ...
    cloud.y = Math.round(random(height-200,height-130 ));
...
function spawnObstacles() {
  if(frameCount % 60 === 0) {
    ...
    obstacle.scale = 0.5;
    obstacle.lifetime = width/obstacle.velocityX + 40;
